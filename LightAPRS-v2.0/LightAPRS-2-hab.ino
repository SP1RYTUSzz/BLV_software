...
//******************************  APRS CONFIG **********************************
char    CallSign[7]="AF1TD "; //Make sure this is 6 chars. use trailing space as needed
...
uint16_t  BeaconWait=30;  //seconds sleep for next beacon (HF or VHF). This is optimized value, do not change this if possible.
...
float     BattMin=3.0;    // min Volts to wake up.
//float     GpsMinVolt=4.5; //min Volts for GPS to wake up. (important if power source is solar panel) 
float     DraHighVolt=8.0;    // min Volts for radio module (DRA818V) to transmit (TX) 1 Watt, below this transmit 0.5 Watt.
